...
(
	...
	CONSTRAINT [FK_ForRes_Gru] FOREIGN KEY ([SiglaGrupo], [NumeroGrupo], [AñoGrupo], [SemestreGrupo])
	REFERENCES [Grupo] ([SiglaCurso], [Numero], [AñoGrupo], [SemestreGrupo]), --ON DELETE NO ACTION ON UPDATE CASCADE
)
